...
const Profile = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(`https://tulirmatrimony.com/controlapi/singlecustomer.php?id=157`);
  ...
  useEffect(() => {
    const fetchDataa = async () => {
      try {
        ...
        const response = await axios.get(
          `https://tulirmatrimony.com/controlapi/singleuserjathagam.php?user_id=157`
        );
        setData(response.data.body);
              ...
              <div class="content-wrapper container">
                <div class="row py-2 profile-mobile">
                  ...
                  <div className="col-lg-4 text-end col-12 mt-2 float-right">
                    <Link to='/Basicdetails' className="btn btn-secondary">
                      Edit My Details
                    </Link>
                  </div>
                </div>
