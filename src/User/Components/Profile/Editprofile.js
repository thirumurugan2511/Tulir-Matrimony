  ...
  const handleSubmit = async (sectionName, sectionData, userid) => {
    ...
    try {
      ...
      switch (sectionName) {
        ...
        case "section2":
          apiUrl =
            "https://tulirmatrimony.com/controlapi/editcustomerresidency.php";
          break;
        case "section3":
          apiUrl =
            "https://tulirmatrimony.com/controlapi/editcustomerphycial.php";
          break;
        case "section4":
          apiUrl =
            "https://tulirmatrimony.com/controlapi/editcustomerfamily.php";
          break;
        case "section5":
          apiUrl =
            "https://tulirmatrimony.com/controlapi/editcustomerpatner.php";
          break;
        case "section6":
          apiUrl =
            "https://tulirmatrimony.com/controlapi/editcustomerimage.php";
          break;
        default:
          throw new Error("Invalid section name");
      }
