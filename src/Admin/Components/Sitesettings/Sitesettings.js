    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          "https://tulirmatrimony.com/controlapi/listuser.php"
        );
                      ...
                      <div class="card-body">
                        ...
                        >
                          <input
                            type="hidden"
                            name="_token"
                            value="xsRbVQIcWzUtaB16B9EQu0T5IiltWdJYP6iUnE2Q"
                          />
                          <div class="mb-3 text-start">
                            <label class="form-label" for="user_name">
                              Username <span class="Form__Error">*</span>
                            </label>
                          ...
                          <div class="mb-3 text-start">
                            <label class="form-label" for="password">
                              Password <span class="Form__Error">*</span>
                            </label>
                          ...
                          <div class="mb-3 text-start">
                            <label class="form-label" for="email">
                              Email ID <span class="Form__Error">*</span>
                            </label>
