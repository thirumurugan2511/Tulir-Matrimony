                        ...
                        <nav className="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme" id="layout-navbar">
                            ...
                            <div className="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                                <ol className="breadcrumb breadcrumb-style2 mb-0">
                                    <li><MdManageHistory className="breadcrumb-item " /></li>
                                            ...
                                            <div className="card-body">
                                                <form onSubmit={handleSubmit}>
                                                    ...
                                                    <div className="mb-3 text-start">
                                                        ...
                                                        <input type="text" required className="form-control required" id="brideid" name="bride_id" placeholder="Bride's ID" onChange={handleChange} />
                                                    </div>
                                                    <div className="mb-3 text-start">
                                                        <label className="form-label" htmlFor="groomname">Groom's Name <span className="Form__Error">*</span></label>
                                                        <input type="text" required className="form-control required" id="groomname" name="groom_name" placeholder="Groom's Name" onChange={handleChange} />
                                                    </div>
                                                    <div className="mb-3 text-start">
                                                        <label className="form-label" htmlFor="groomid">Groom's Id <span className="Form__Error">*</span></label>
                                                        <input type="text" required className="form-control required" id="groomid" name="groom_id" placeholder="Groom's Id" onChange={handleChange} />
                                                    </div>
                                                    <div className="mb-3 text-start">
                                                        <label className="form-label" htmlFor="marriagedate">Your Marriage Date <span className="Form__Error">*</span></label>
                                                        <input className="form-control required" type="date" id="marriagedate" name="marriage_date" onChange={handleChange} />
                                                    </div>
                                                    <div className="mb-3 text-start">
