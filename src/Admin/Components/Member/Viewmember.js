                              ...
                              <div class="inner_views_detailsFGH">
                                <div class="row text-start">
                                  ...
                                  <div class="col-lg-3 mb-lg-4 col-md-3 mb-md-4 col-sm-6 mb-sm-3 col-6 mb-3">
                                    <div class="detalistsleg">
                                      <h5 class="py-2">
                                        <span>Plan Register Date :</span>{" "}
                                        
                                        {formatDate(
                                          profileData.body.plan_register_date
                                        )}
                                      </h5>
                                    </div>
                                  </div>
                                ...
                                <div class="row mx-auto">
                                  <div className="text-start">
                                    <Link
                                      ...
                                      class="icon_usBox"
                                    >
                                      <MdModeEdit class="bx bxs-edit" /> Add
                                      Jathagam
                                    </Link>
                                  </div>
