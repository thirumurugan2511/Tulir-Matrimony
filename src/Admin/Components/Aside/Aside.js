        ...
        <>
            ...
            <aside id="layout-menu" className="layout-menu menu-vertical menu bg-menu-theme">
                <div className="app-brand demo">
                    ...
                    {/* <img src="https://www.gloriousmatrimonial.com/public//assets/logo/2717431707816795.png" alt className="w-100" /> */}
                ...
                <ul className="menu-inner py-1">
                    ...
                    <li className={`menu-item ${activeMenuItem === 'dashboard' ? 'active open' : ''}`}>
                        <Link to="/Dashboard" className="menu-link" onClick={() => setActiveMenuItem('dashboard')}>
                    ...
                    <li className={`menu-item ${activeMenuItem === 'siteSettings' ? 'active open' : ''}`}>
                        <Link to="/Sitesettings" className="menu-link menu-toggle" onClick={() => { toggleSubMenu('siteSettings'); }}>
                    ...
                    <li className={`menu-item ${activeMenuItem === 'newDetails' ? 'active open' : ''}`}>
                        <Link to="javascript:void(0);" className="menu-link menu-toggle" onClick={() => toggleSubMenu('newDetails')}>
                    ...
                    <li className={`menu-item ${activeMenuItem === 'approval' ? 'active open' : ''}`}>
                        <Link to="javascript:void(0);" className="menu-link menu-toggle" onClick={() => toggleSubMenu('approval')}>
