            ...
            align-items-center bg-navbar-theme" id="layout-navbar">
                ...
                <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                    <ol class="breadcrumb breadcrumb-style2 mb-0">
                        ...
                        <li class="breadcrumb-item active">  Manage Mother Tongue </li>
                    </ol>
                ...
                <div class="card-body">
                    <form id="addEditForm" name="addEditForm" action="https://gloriousmatrimonial.com/admin/religion/addEdit" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 text-start">
                                        ...
                                        <input type="text" required="" class="form-control required" id="religion_name" name="religion_name" placeholder="Mothertongue" value=""/>
