...
const Education = () => {
  return (
   ...
   <li class="breadcrumb-item active" style={{padding: '2px 10px'}}>  Manage Education </li>
                   </ol>
...
<div class="col-md-2">
            <a href="/Educationadd" class="fw-bold mb-4 btn btn-info"><MdPostAdd class="bx bx-plus-circle" /> Add New</a>
        </div>
