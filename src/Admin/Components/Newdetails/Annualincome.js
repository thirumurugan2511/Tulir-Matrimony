...
<li class="breadcrumb-item active" style={{padding: '2px 10px'}}>  Manage Annual Income </li>
                   </ol>
...
<div class="col-md-2">
            <a href="/Annualaddincomeadd" class="fw-bold mb-4 btn btn-info"><MdPostAdd class="bx bx-plus-circle" /> Add New</a>
        </div>
